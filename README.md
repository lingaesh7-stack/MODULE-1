...
1.# Program: Check if Number is Equal to 000
...
2.# Program: Display Character from ASCII Value
...
3.# Program: Arithmetic Operations Using Switch Statement
...
4.# Program: Grade Evaluation Based on Marks
...
5.# Program: Simple and Compound Interest Calculation
